package com.diary.diaryandnotes.In_App_Purchase;
...
import com.diary.diaryandnotes.In_App_Purchase.util.IabBroadcastReceiver;
import com.diary.diaryandnotes.In_App_Purchase.util.IabHelper;
import com.diary.diaryandnotes.In_App_Purchase.util.IabResult;
import com.diary.diaryandnotes.In_App_Purchase.util.Inventory;
import com.diary.diaryandnotes.In_App_Purchase.util.Purchase;
import com.diary.diaryandnotes.R;

import java.util.ArrayList;
import java.util.List;


import static com.diary.diaryandnotes.In_App_Purchase.Constants.SKU_DELAROY_MONTHLY;
import static com.diary.diaryandnotes.In_App_Purchase.Constants.SKU_DELAROY_SIXMONTH;
import static com.diary.diaryandnotes.In_App_Purchase.Constants.SKU_DELAROY_THREEMONTH;
import static com.diary.diaryandnotes.In_App_Purchase.Constants.SKU_DELAROY_YEARLY;
import static com.diary.diaryandnotes.In_App_Purchase.Constants.base64EncodedPublicKey;

public class subscribe_activity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    public static String mypref = "My_pref";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        get_value = getIntent().getIntExtra("msg",1);

        preferences = getSharedPreferences(mypref,MODE_PRIVATE);

        pd = new ProgressDialog(subscribe_activity.this);
        pd.setCanceledOnTouchOutside(false);
        pd.setCancelable(false);
        pd.setMessage("Please wait while fetching subscription data");
        pd.show();

        ll_show = findViewById(R.id.rl_show);
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(subscribe_activity.this);
