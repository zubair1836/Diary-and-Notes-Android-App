...
public class Rv_Link_Adapter extends RecyclerView.Adapter<Rv_Link_Adapter.ViewHolder> {

    ArrayList<String> arl_folder_name;
    Context c;
    ArrayList<String> arl_lastmsg;

    Rv_Link_Adapter(ArrayList<String> arl_folder_name, ArrayList<String> arl_lastmsg) {
    ...
    @NonNull
    @Override
    public Rv_Link_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        c = parent.getContext();
    ...
    @Override
    public void onBindViewHolder(@NonNull Rv_Link_Adapter.ViewHolder holder, int position) {
        ...
        public void SetData(final int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(c,Add_Link_Activity.class);
                    i.putExtra("foldername",arl_folder_name.get(position));
                    c.startActivity(i);
